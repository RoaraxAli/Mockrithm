...
export default async function ResumeDashboardPage() {
  ...
  if (resumes.length === 0) {
    return (
      <div className="flex flex-col gap-6 w-full items-center justify-center animate-fadeIn py-8">
        <OnboardingWelcome />
        <WorkspaceGateway />
      </div>
    );
  ...
  return (
    <div className="flex flex-col gap-8 font-mona-sans max-w-6xl mx-auto w-full animate-fadeIn">
