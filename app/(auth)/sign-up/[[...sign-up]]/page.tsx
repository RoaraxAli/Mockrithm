      ...
      <section className="relative hidden lg:flex w-[52%] flex-col items-center justify-end pb-32 px-12 rounded-3xl overflow-hidden shadow-2xl h-full">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            <h2 className="text-4xl font-medium tracking-tight whitespace-nowrap">Join Mockrithm</h2>
            <p className="text-white/60 text-sm leading-relaxed px-4">
              Activate your AI-powered career simulator and prepare.
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="space-y-3">
            ...
            <StepItem number={2} text="Calibrate experience level" />
            <StepItem number={3} text="Activate your workspace" />
          </motion.div>
        </motion.div>
      </section>
