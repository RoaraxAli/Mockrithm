  ...
  return (
    <div className="w-full flex flex-col font-mona-sans relative z-10 select-none pb-12">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 relative z-10">
        {/* Total Sessions Card */}
        <div className="relative p-6 backdrop-blur-2xl bg-zinc-950/40 border border-white/5 rounded-2xl shadow-xl overflow-hidden group hover:border-white/15 transition-all duration-300">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8 relative z-10">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="p-6 backdrop-blur-3xl bg-zinc-950/40 border border-white/5 rounded-2xl shadow-xl flex flex-col justify-between overflow-hidden relative group hover:border-white/10 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Pacing Speedometer */}
            <div className="p-6 backdrop-blur-3xl bg-zinc-950/40 border border-white/5 rounded-2xl shadow-xl flex flex-col justify-between group hover:border-white/10 transition-all duration-300">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="p-6 backdrop-blur-3xl bg-zinc-950/40 border border-white/5 rounded-2xl shadow-xl flex flex-col gap-4 group hover:border-white/10 transition-all duration-300">
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                { name: "Backend Engineer", type: "System Design", level: "Senior", bg: "from-zinc-950 to-zinc-900" },
                { name: "Full-Stack Engineer", type: "Hybrid", level: "Lead", bg: "from-zinc-900 via-zinc-950 to-zinc-900" },
                { name: "STAR Behavioral", type: "Behavioral", level: "All Tiers", bg: "from-zinc-950 to-zinc-900" }
              ].map((preset) => (
                <Link 
                  key={preset.name}
          ...
          <div className="p-6 backdrop-blur-3xl bg-zinc-950/40 border border-white/5 rounded-2xl shadow-xl flex flex-col justify-between min-h-[220px] relative group hover:border-white/10 transition-all duration-300">
      ...
      {/* 4. ATS Resume Workspace Bento Card */}
          ...
          {loadingData ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-5 bg-zinc-950/30 border border-white/5 rounded-xl space-y-3">
                <span className="text-[8px] font-mono font-bold text-zinc-500 uppercase tracking-widest flex items-center gap-1.5">
      ...
      {/* 5. Scrollable Evaluation Logs Timeline */}
          ...
          <div className="max-h-[380px] overflow-y-auto pr-2 space-y-4">
            {loadingData ? (
                      ...
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4.5 bg-zinc-950/30 hover:bg-zinc-900/30 border border-white/5 hover:border-white/10 rounded-xl transition-all duration-300">
                        <div className="flex flex-col gap-1.5 max-w-xl">
                          <div className="flex items-center gap-2 flex-wrap">
                            <span className="text-[8px] font-mono text-zinc-500 font-bold uppercase">{date}</span>
                          ...
                          {strengthsList.length > 0 && (
                            <div className="flex flex-wrap gap-1 mt-1">
                              {strengthsList.slice(0, 2).map((str: string, i: number) => (
                                <span 
                                  key={i} 
                                  className="text-[7.5px] font-semibold text-zinc-400 bg-white/[0.02] border border-white/5 px-2 py-0.5 rounded"
                                >
                                  {str}
                                </span>
                              ))}
                        ...
                        <div className="flex items-center gap-6 shrink-0 justify-between md:justify-end">
                          ...
                          <Link 
                            ...
                            className="h-8 px-3.5 rounded-lg bg-zinc-900 border border-white/5 text-zinc-400 hover:text-white hover:bg-zinc-800 text-[8.5px] font-mono font-bold uppercase tracking-wider flex items-center justify-center transition-all cursor-pointer"
                          >
                            Details
                          </Link>
                        </div>
              ...
              <div className="py-12 border border-dashed border-zinc-900 rounded-xl bg-zinc-950/10 flex flex-col items-center justify-center text-center p-6 gap-2">
                ...
                <p className="text-[9px] text-zinc-500 font-bold uppercase tracking-wider">No completed trials found</p>
